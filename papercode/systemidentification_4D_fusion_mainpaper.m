...
eta=1.72;%2699002882462;  %神经元间距
keta=1.37;%6766666832312;
...
gamma=0.0135;%7271531659464;


ksigma=0.005;%06580074297906;
sigma=gamma*ksigma;
%sigma=0.0001/8;
...
u_smooth_interval=26;
du_smooth_interval=2;
...
% sigma=0.005;
% W=Wfusion4_mod(SSinput,Winput,sigma);
W=W';
end
toc
