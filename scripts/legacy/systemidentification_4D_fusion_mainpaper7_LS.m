...
eta=1.8;%2699002882462;  %神经元间距
keta=1.45;%6766666832312;
...
gamma=10e-05;%7271531659464;


ksigma=0.025;%06580074297906;
sigma=gamma*ksigma;
%sigma=0.0001/8;
...
u_smooth_interval=22;
du_smooth_interval=10;
...
sigma=[0,0];
W=Wfusion8_mod(SSinput,Winput,sigma);
W=W';
